...
//Makes a random number from 0 - 8
...
*/
function gameOver() {
  if(time > 0){                         // TODO: Write your code here
    timeoutId = showUp();
    return timeoutId;
  } else {
    gameStopped = stopGame();
...
function updateScore() {
  points++;                            // TODO: Write your code here
...
//Uses difficulty of level to adjust length
